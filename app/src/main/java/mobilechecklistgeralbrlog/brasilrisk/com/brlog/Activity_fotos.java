    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        btn_fim.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (result.getCodTipoChecklist() != 4) {
                    if (imagem.getPrimeiraFoto() != null && imagem.getSegundaFoto() != null
                        ...
                        DialogShow_Fotos("Para dar continuidade, é necessário que sejam fotografadas 3 imagens !");
                    }
                } else {
                    if (imagem.getPrimeiraFoto() != null || imagem.getSegundaFoto() != null
                            || imagem.getTerceiraFoto() != null) {
                                ...
                                public void onResponse(Call<Retorno> call, Response<Retorno> response) {
                                    ...
                                    if (response.isSuccessful()) {
                                        ...
                                        if (response.body().getStatusCode() == 200) {
                                            ...
                                            dialog.dismiss();
                                            Toast.makeText(Activity_fotos.this, response.body().getMensagem(), Toast.LENGTH_SHORT).show();
                                        }
                                    } else {
                                        dialog.dismiss();
                                        Toast.makeText(Activity_fotos.this, response.body().getMensagem(), Toast.LENGTH_SHORT).show();
